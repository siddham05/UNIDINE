...
<head>
    ...
    <title>Welcome | UNIDINE | FOODMUNCH </title>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="d-flex text-center text-white position-relative promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-5">
            <h1 class="display-5 fw-normal">Welcome to UNIDINE</h1>
            <p class="lead fw-normal">Food ordering system of Bennett University</p>
    ...
    <div class="container p-5" id="recommended-shop">
        ...
        <iframe src="chatbot/index.html" width="350" height="430" style="border:none;"></iframe>
